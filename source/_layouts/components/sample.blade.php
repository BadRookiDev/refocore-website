<div class="card card-side bg-base-100 rounded-none refo-corner-cut">
    <div class="refo-corner-cut relative">
        <div class="absolute top-0 left-0 z-50">
            <div class="block relative text-white font-bold" style="padding-top: 2px; padding-left: 8px">
        ...
        <img src="{{ $sampleImgUrl }}" alt="{{ $sampleTitle }} waveform"/>
    </div>

    <div class="card-body flex justify-between flex-col">
        <h6 class="font-semibold sm:text-lg md:text-xs lg:text-lg xl:!text-xs">{{ $sampleTitle }} test test</h6>

        <div class="flex gap-x-4">
            <button id="{{ str_replace(" ", "-", $sampleTitle)."-button" }}">
                <svg viewBox="0 0 24 24" class="w-7 sm:w-10 md:w-5 lg:w-8 xl:w-6" xmlns="http://www.w3.org/2000/svg">
