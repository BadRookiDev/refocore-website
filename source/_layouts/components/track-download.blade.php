<div class="pt-32 -mt-16" id="{{ $id }}">
    <div class="flex w-full gap-8 flex-wrap sm:flex-nowrap">
        ...
        <div class="w-full sm:w-1/2 md:w-1/3 lg:w-1/4">
            <div class="w-full h-full rounded-sm p-4 bg-base-100 flex items-center drop-shadow-md">
                <div class="w-full flex items-center justify-center sm:block">
                    ...
                    <button class="inline-block sm:w-full p-2 rounded-full sm:mt-2" onclick="downloadFile('{{ $downloadBuyUrl }}')"
