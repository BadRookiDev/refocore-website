    ...
    <section class="bg-base-100 z-10 relative">
        <div class="relative bg-base-200/20 dark:bg-base-200">
            <div class="py-32 container mx-auto px-16 relative">
                <div class="-mt-32">
                    @include('_layouts.components.track-download', ['colorClass' => 'accent', 'trackId' => '2159221542', 'downloadBuyUrl' => 'https://s3.eu-central-2.wasabisys.com/cdn.refocore.top/BlackPink - Jump (Refocore Remix) [extended version].mp3', 'isFree' => true, 'id' => 'jump-remix'])
